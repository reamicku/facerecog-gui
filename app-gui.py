...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Wprowadź swoje imię", fg="#263942", font='Helvetica 12 bold').grid(row=0, column=0, pady=10, padx=5)
        ...
        self.buttoncanc = tk.Button(self, text="Anuluj", bg="#ffffff", fg="#263942", command=lambda: controller.show_frame("StartPage"))
        self.buttonext = tk.Button(self, text="Dalej", fg="#ffffff", bg="#263942", command=self.start_training)
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Rozpocznij", command=self.openwebcam, fg="#ffffff", bg="#263942")
        ...
        button4 = tk.Button(self, text="Wróc na stronę główną", command=lambda: self.controller.show_frame("StartPage"), bg="#ffffff", fg="#263942")
